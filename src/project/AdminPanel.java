...
public class AdminPanel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        updateButton.setBackground(new java.awt.Color(51, 0, 255));
        ...
        checkStockButton.setBackground(new java.awt.Color(51, 0, 255));
        ...
        billingButton.setBackground(new java.awt.Color(51, 0, 255));
        ...
        mCat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Adults", "Teens", "Kids" }));
        ...
        stockStatusCat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Adults", "Teens", "Kids" }));
        ...
        delUpdateCat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Adults", "Teens", "Kids" }));
        ...
        stockStatusCat.getAccessibleContext().setAccessibleDescription("");
    ...
    private void billingButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_billingButtonMouseReleased
        // TODO add your handling code here:
        billingButton.setBackground(new Color(51, 0, 255));
    ...
    private void billingButtonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_billingButtonMouseEntered
        // TODO add your handling code here:
        billingButton.setBackground(new Color(51, 0, 204));
    ...
    private void checkStockButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkStockButtonActionPerformed
            ...
            ArrayList<ProductList> list = AdultsDB.checkStock();
    ...
    private void checkStockButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_checkStockButtonMouseReleased
        // TODO add your handling code here:
        checkStockButton.setBackground(new Color(51, 0, 255));
    ...
    private void checkStockButtonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_checkStockButtonMouseEntered
        // TODO add your handling code here:
        checkStockButton.setBackground(new Color(51, 0, 204));
    ...
    private void updateButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateButtonMouseReleased
        // TODO add your handling code here:
        updateButton.setBackground(new Color(51, 0, 255));
    ...
    private void updateButtonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateButtonMouseEntered
        // TODO add your handling code here:;
        updateButton.setBackground(new Color(51, 0, 204));
    ...
    private void LogInButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LogInButtonActionPerformed
        // TODO add your handling code here:
        try{
            if(mCat.getSelectedItem().equals("Teens")){
            if(!path.equals(""))
                TeensDB.insertIntoTeensDB(mBrand.getText(), mModel.getText(), Integer.parseInt(mPrice.getText()), 
                        Integer.parseInt(mQty.getText()), mDescription.getText(), path);
        }
        
        else if(mCat.getSelectedItem().equals("Adults")){
            if(!path.equals(""))
                AdultsDB.insertIntoAdultsDB(mBrand.getText(), mModel.getText(), Integer.parseInt(mPrice.getText()), 
                        Integer.parseInt(mQty.getText()), mDescription.getText(), path);
        }
    ...
    private void updateStockButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateStockButtonActionPerformed
       ...
       try{
            ...
            if(stockStatusCat.getSelectedItem().equals("Adults")){
                AdultsDB.flag = true;
                AdultsDB.updateAdultsDB(model, qty);
            }

            else if(stockStatusCat.getSelectedItem().equals("Teens")){
                TeensDB.flag = true;
                TeensDB.updateTeensDB(model, qty);
            }
    ...
    private void delEntryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delEntryActionPerformed
        ...
        if(delUpdateCat.getSelectedItem().equals("Adults")){
            AdultsDB.delete(del);
        }
        else if(delUpdateCat.getSelectedItem().equals("Teens")){
            TeensDB.delete(del);
        }
