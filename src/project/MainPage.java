...
public class MainPage extends javax.swing.JFrame {
    ...
    public MainPage() {
        ...
        ArrayList<ProductList> list = AdultsDB.homePageContent();
        ...
        model.setRowCount(0); //To clear teensTable
        ...
        for(int i=0; i<list.size(); i++){
            ...
            ImageIcon ii = new ImageIcon(getClass().getResource("/products/adults/"+temp));
        ...
        for(int i=0; i<list.size(); i++){
            ...
            rowData[4] = list.get(i).getDescription();
            String temp = list.get(i).getMimage();
            ImageIcon ii = new ImageIcon(getClass().getResource("/products/teens/"+temp));
            Image resizedImage = ii.getImage();
            ii = new ImageIcon(resizedImage.getScaledInstance(160, 160, Image.SCALE_SMOOTH));
    ...
    private void initComponents() {
        ...
        adultsButton = new javax.swing.JButton();
        accountButton = new javax.swing.JButton();
        cartButton = new javax.swing.JButton();
        teensButton = new javax.swing.JButton();
        ...
        adultsPanel = new javax.swing.JPanel();
        jScrollPane3 = new javax.swing.JScrollPane();
        adultsTable = new javax.swing.JTable();
        ...
        teensPanel = new javax.swing.JPanel();
        jScrollPane1 = new javax.swing.JScrollPane();
        teensTable = new javax.swing.JTable();
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/Brick.png"))); // NOI18N

        jSeparator6.setForeground(new java.awt.Color(0, 0, 204));
        jSeparator6.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jSeparator6.setOpaque(true);

        searchBar.setBackground(new java.awt.Color(51, 0, 255));
        ...
        newlyAdded.setBackground(new java.awt.Color(51, 0, 255));
        ...
        adultsButton.setBackground(new java.awt.Color(51, 0, 255));
        adultsButton.setFont(new java.awt.Font("Roboto", 0, 20)); // NOI18N
        adultsButton.setForeground(new java.awt.Color(255, 255, 255));
        adultsButton.setText("For Adults");
        adultsButton.setToolTipText("Advanced sets");
        adultsButton.setBorderPainted(false);
        adultsButton.setContentAreaFilled(false);
        adultsButton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        adultsButton.setOpaque(true);
        adultsButton.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                adultsButtonMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                adultsButtonMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                adultsButtonMouseExited(evt);
            }
            public void mousePressed(java.awt.event.MouseEvent evt) {
                adultsButtonMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                adultsButtonMouseReleased(evt);
            }
        });
        adultsButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                adultsButtonActionPerformed(evt);
            }
        });

        accountButton.setBackground(new java.awt.Color(51, 0, 255));
        ...
        cartButton.setBackground(new java.awt.Color(51, 0, 255));
        ...
        teensButton.setBackground(new java.awt.Color(51, 0, 255));
        teensButton.setFont(new java.awt.Font("Roboto", 0, 20)); // NOI18N
        teensButton.setForeground(new java.awt.Color(255, 255, 255));
        teensButton.setText("For Teens");
        teensButton.setToolTipText("Medium-difficulty sets");
        teensButton.setActionCommand("Teens");
        teensButton.setBorderPainted(false);
        teensButton.setContentAreaFilled(false);
        teensButton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        teensButton.setOpaque(true);
        teensButton.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                teensButtonMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                teensButtonMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                teensButtonMouseExited(evt);
            }
            public void mousePressed(java.awt.event.MouseEvent evt) {
                teensButtonMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                teensButtonMouseReleased(evt);
            }
        });
        teensButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                teensButtonActionPerformed(evt);
            }
        });

        kidsButton.setBackground(new java.awt.Color(51, 0, 255));
        kidsButton.setFont(new java.awt.Font("Roboto", 0, 20)); // NOI18N
        kidsButton.setForeground(new java.awt.Color(255, 255, 255));
        kidsButton.setText("For Kids");
        kidsButton.setToolTipText("Easy-level sets");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(23, 23, 23)
                .addComponent(adultsButton, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(26, 26, 26)
                .addComponent(teensButton, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                .addComponent(adultsButton, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addComponent(cartButton, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(teensButton, javax.swing.GroupLayout.PREFERRED_SIZE, 51, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        adultsTable.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        adultsTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        adultsTable.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        adultsTable.setSelectionBackground(new java.awt.Color(0, 150, 136));
        adultsTable.getTableHeader().setReorderingAllowed(false);
        adultsTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                adultsTableMouseClicked(evt);
            }
        });
        jScrollPane3.setViewportView(adultsTable);

        javax.swing.GroupLayout adultsPanelLayout = new javax.swing.GroupLayout(adultsPanel);
        adultsPanel.setLayout(adultsPanelLayout);
        adultsPanelLayout.setHorizontalGroup(
            adultsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jScrollPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 1200, Short.MAX_VALUE)
        );
        adultsPanelLayout.setVerticalGroup(
            adultsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jScrollPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 590, Short.MAX_VALUE)
        );

        cardParentPanel.add(adultsPanel, "card4");
        ...
        teensTable.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        teensTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        teensTable.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        teensTable.setSelectionBackground(new java.awt.Color(0, 150, 136));
        teensTable.getTableHeader().setReorderingAllowed(false);
        teensTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                teensTableMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(teensTable);

        javax.swing.GroupLayout teensPanelLayout = new javax.swing.GroupLayout(teensPanel);
        teensPanel.setLayout(teensPanelLayout);
        teensPanelLayout.setHorizontalGroup(
            teensPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 1200, Short.MAX_VALUE)
        );
        teensPanelLayout.setVerticalGroup(
            teensPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 590, Short.MAX_VALUE)
        );

        cardParentPanel.add(teensPanel, "card3");
        ...
        signUpNameField.setForeground(new java.awt.Color(0, 0, 204));
        ...
        signUpEmailField.setForeground(new java.awt.Color(0, 0, 204));
        ...
        signUpCardNumberField.setForeground(new java.awt.Color(0, 0, 204));
        ...
        signUpPasswordField.setForeground(new java.awt.Color(0, 0, 204));
        ...
        showPassword.setForeground(new java.awt.Color(0, 0, 204));
        ...
        LogUpButton.setBackground(new java.awt.Color(0, 0, 204));
        ...
        signUpUsernameField.setForeground(new java.awt.Color(0, 0, 204));
        ...
        signInUsernameField.setForeground(new java.awt.Color(0, 0, 204));
        ...
        jSeparator9.setForeground(new java.awt.Color(0, 0, 204));
        ...
        signInPasswordField.setForeground(new java.awt.Color(0, 0, 204));
        ...
        showPassword1.setForeground(new java.awt.Color(0, 0, 204));
    ...
    private void newlyAddedMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_newlyAddedMouseReleased
        // TODO add your handling code here:
        newlyAdded.setBackground(new Color(51, 0, 255));
    ...
    private void newlyAddedMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_newlyAddedMousePressed
        // TODO add your handling code here:
        newlyAdded.setBackground(new Color(0, 0, 204));
    ...
    private void newlyAddedMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_newlyAddedMouseEntered
        // TODO add your handling code here:;
        newlyAdded.setBackground(new Color(51, 0, 204));
    ...
    private void adultsButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_adultsButtonMouseClicked
        // TODO add your handling code here:
        cardParentPanel.removeAll();
        cardParentPanel.add(adultsPanel);
        cardParentPanel.repaint();
        cardParentPanel.revalidate();
    }//GEN-LAST:event_adultsButtonMouseClicked

    private void adultsButtonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_adultsButtonMouseEntered
        // TODO add your handling code here:
         adultsButton.setBackground(new Color(51, 0, 204));
    }//GEN-LAST:event_adultsButtonMouseEntered

    private void adultsButtonMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_adultsButtonMouseExited
        // TODO add your handling code here:
        adultsButton.setBackground(new Color(51, 0, 255));
    }//GEN-LAST:event_adultsButtonMouseExited

    private void adultsButtonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_adultsButtonMousePressed
        // TODO add your handling code here:
        adultsButton.setBackground(new Color(0, 0, 204));
    }//GEN-LAST:event_adultsButtonMousePressed

    private void adultsButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_adultsButtonMouseReleased
        // TODO add your handling code here:
         adultsButton.setBackground(new Color(51, 0, 255));
    }//GEN-LAST:event_adultsButtonMouseReleased

    private void adultsButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_adultsButtonActionPerformed
        // TODO add your handling code here:
        ProductInformation.categoryChooser = "adults";
        ArrayList<ProductList> list = AdultsDB.TableGenerator();
        Object rowData[] = new Object[6];
        
        DefaultTableModel model =  (DefaultTableModel) adultsTable.getModel();
        DefaultTableCellRenderer centerRenderer = new DefaultTableCellRenderer();
        centerRenderer.setHorizontalAlignment( JLabel.CENTER );
        adultsTable.getColumnModel().getColumn(0).setCellRenderer( centerRenderer );
        adultsTable.getColumnModel().getColumn(1).setCellRenderer( centerRenderer );
        adultsTable.getColumnModel().getColumn(2).setCellRenderer( centerRenderer );
        adultsTable.getColumnModel().getColumn(3).setCellRenderer( centerRenderer );
        adultsTable.getColumnModel().getColumn(4).setCellRenderer( centerRenderer );
        ...
        for(int i=0; i<list.size(); i++){
            ...
            rowData[5] = ii;
            model.addRow(rowData);
            adultsTable.setRowHeight(150);
            adultsTable.getColumnModel().getColumn(5).setPreferredWidth(150);
        }
    }//GEN-LAST:event_adultsButtonActionPerformed
    ...
    private void accountButtonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_accountButtonMouseEntered
        // TODO add your handling code here:
        accountButton.setBackground(new Color(51, 0, 204));
    ...
    private void accountButtonMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_accountButtonMouseExited
        // TODO add your handling code here:
        accountButton.setBackground(new Color(51, 0, 255));
    ...
    private void accountButtonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_accountButtonMousePressed
        // TODO add your handling code here:
        accountButton.setBackground(new Color(0, 0, 204));
    ...
    private void cartButtonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cartButtonMouseEntered
        // TODO add your handling code here:
        cartButton.setBackground(new Color(51, 0, 204));
    ...
    private void cartButtonMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cartButtonMouseExited
        // TODO add your handling code here:
        cartButton.setBackground(new Color(51, 0, 255));
    ...
    private void cartButtonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cartButtonMousePressed
        // TODO add your handling code here:
        cartButton.setBackground(new Color(0, 0, 204));
    ...
    private void teensButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_teensButtonMouseClicked
        // TODO add your handling code here:
        cardParentPanel.removeAll();
        cardParentPanel.add(teensPanel);
        cardParentPanel.repaint();
        cardParentPanel.revalidate();
    }//GEN-LAST:event_teensButtonMouseClicked

    private void teensButtonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_teensButtonMouseEntered
        // TODO add your handling code here:
        teensButton.setBackground(new Color(51, 0, 204));
    }//GEN-LAST:event_teensButtonMouseEntered

    private void teensButtonMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_teensButtonMouseExited
        // TODO add your handling code here:
        teensButton.setBackground(new Color(51, 0, 255));
    }//GEN-LAST:event_teensButtonMouseExited

    private void teensButtonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_teensButtonMousePressed
        // TODO add your handling code here:
        teensButton.setBackground(new Color(0, 0, 204));
    }//GEN-LAST:event_teensButtonMousePressed

    private void teensButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_teensButtonMouseReleased
        // TODO add your handling code here:
        teensButton.setBackground(new Color(51, 0, 255));
    }//GEN-LAST:event_teensButtonMouseReleased

    
    private void teensButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_teensButtonActionPerformed
        // TODO add your handling code here:
        ProductInformation.categoryChooser = "teens";
        ArrayList<ProductList> list = TeensDB.TableGenerator();
        String[] columnName = {};
        Object rowData[] = new Object[6];
        
        DefaultTableModel model =  (DefaultTableModel) teensTable.getModel();
        DefaultTableCellRenderer centerRenderer = new DefaultTableCellRenderer();
        centerRenderer.setHorizontalAlignment( JLabel.CENTER );
        teensTable.getColumnModel().getColumn(0).setCellRenderer( centerRenderer );
        teensTable.getColumnModel().getColumn(1).setCellRenderer( centerRenderer );
        teensTable.getColumnModel().getColumn(2).setCellRenderer( centerRenderer );
        teensTable.getColumnModel().getColumn(3).setCellRenderer( centerRenderer );
        teensTable.getColumnModel().getColumn(4).setCellRenderer( centerRenderer );
        ...
        for(int i=0; i<list.size(); i++){
            ...
            rowData[5] = ii;
            model.addRow(rowData);
            teensTable.setRowHeight(150);
            teensTable.getColumnModel().getColumn(5).setPreferredWidth(150);
        }
        
    }//GEN-LAST:event_teensButtonActionPerformed
    ...
    private void kidsButtonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kidsButtonMouseEntered
        // TODO add your handling code here:
        kidsButton.setBackground(new Color(51, 0, 204));
    ...
    private void kidsButtonMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kidsButtonMouseExited
        // TODO add your handling code here:
        kidsButton.setBackground(new Color(51, 0, 255));
    ...
    private void kidsButtonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kidsButtonMousePressed
        // TODO add your handling code here:
        kidsButton.setBackground(new Color(0, 0, 204));
    ...
    private void signInButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_signInButtonMouseReleased
        // TODO add your handling code here:
        signInButton.setForeground(new Color(51, 0, 255));
    ...
    private void signInButtonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_signInButtonMousePressed
        // TODO add your handling code here:
        signInButton.setForeground(new Color(0, 0, 204));
    ...
    private void teensTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_teensTableMouseClicked
        // TODO add your handling code here:
        pi.setVisible(true);
        pi.pack();
        
        int selectedRow = teensTable.getSelectedRow();
        TableModel tm = teensTable.getModel();
    ...
    }//GEN-LAST:event_teensTableMouseClicked
    ...
    private void adultsTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_adultsTableMouseClicked
        // TODO add your handling code here:
        pi.setVisible(true);
        pi.pack();
        
        int selectedRow = adultsTable.getSelectedRow();
        TableModel tm = adultsTable.getModel();
        ...
        pi.productInfoFeature.setText(feature);
        pi.productPhoto.setIcon(img);
    }//GEN-LAST:event_adultsTableMouseClicked
    ...
    private void searchButtonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_searchButtonMousePressed
        // TODO add your handling code here:
        searchButton.setBackground(new Color(0, 0, 204));
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        ArrayList<ProductList> list = Search.teensSearch(searchBar.getText());
        Object rowData[] = new Object[6];
        int i, j, k;
        ...
        if(searchBar.getText().equals(""))
        ...
        else if(Search.adults==0 && Search.teens==0 && Search.kids==0)
            ...
            for(k=i; k<Search.teens+Search.adults; k++){
            ...
            System.out.println();
            for(j=k; j<Search.teens+Search.adults+Search.kids; j++){
    ...
    private void searchTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_searchTableMouseClicked
        ...
        if(Search.adults!=0 && rowIndex<Search.adults)
            ProductInformation.categoryChooser = "adults";
        else if(Search.teens!=0 && rowIndex>=Search.adults && rowIndex<Search.adults+Search.teens)
            ProductInformation.categoryChooser = "teens";
        else 
            ProductInformation.categoryChooser = "kids";
...
//        });
        ...
        newMain.setTitle("Brick Shop Client");
    ...
    private javax.swing.JButton adultsButton;
    private javax.swing.JPanel adultsPanel;
    private javax.swing.JTable adultsTable;
    ...
    private javax.swing.JButton teensButton;
    private javax.swing.JPanel teensPanel;
    private javax.swing.JTable teensTable;
